...
Source0  : https://files.pythonhosted.org/packages/23/3f/f2251c754073cda0f00043a707cba7db103654722a9afed965240a0b2b43/pkginfo-1.7.1.tar.gz
...
%prep
%setup -q -n pkginfo-1.7.1
cd %{_builddir}/pkginfo-1.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636412991
...
cp %{_builddir}/pkginfo-1.7.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pkginfo/03162d5b27cb1ca3f768d50b3ea24877f6543dbd
